...
<aside class="main-sidebar">
        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-header">
              <h3 class="box-title">
              <input type="button" value="按时间" class="btn btn-warning" style="line-height: 1.0;" onclick="news()"/>
			  </h3>

              <div class="box-tools">
                <form id="" name="" action="news/find" method="get" >
	                <div class="input-group input-group-sm" style="width: 180px;float:right;">
	                  <input type="text" name="key" class="form-control pull-right" value="" placeholder="查询" style="height:34px;">
	                ...
	                <div style='display: inline-block'>
                           ...
                           <script>
                           	...
                           	$('#lang').on('change', function() {
                                   ...
                                   if(text){
                                   	$('#language').val(text);
                                   	window.location.href="news/lang?lang="+lang.value+"&hot=1";
                                   }
                               });
                           </script>
              </div>
              ...
              <table class="table table-hover" style="width:100%;margin-top:15px;">
                ...
                <c:forEach var="xmind" items="${xmindList.list}" varStatus="idx">
	                <tr>
	                  ...
	                  <td width="5%" align="center">${xmind.username }</td>
		  ...
		  <div class="pagelist" style="float:right;margin-top: 5px;">
			<a class="btn-inline" style="border-bottom: none;display: ;" href="javascript:window.location.href='<%=basePath%>news/hotcontent?pageNo=1'">首页</a>
			<a class="btn-inline" style="border-bottom: none;display: ;" href="javascript:window.location.href='<%=basePath%>news/hotcontent?pageNo=${xmindList.previou}'">上一页</a>
			<a class="btn-inline" style="border-bottom: none;display: ;" >当前显示第&nbsp;<i class="blue">${xmindList.pageNo}&nbsp;</i>页</a>
			<a class="btn-inline" style="border-bottom: none;display: ;" href="javascript:window.location.href='<%=basePath%>news/hotcontent?pageNo=${xmindList.next}'">下一页</a>
			<a class="btn-inline" style="border-bottom: none;display: ;" href="javascript:window.location.href='<%=basePath%>news/hotcontent?pageNo=${xmindList.last}'">尾页</a>
		  </div>
            </div>
            <!-- /.box-body -->
          </div>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2017-2099 <a href="<%=basePath%>news/hotcontent">朱利尔</a>.</strong> All rights reserved.
  </footer>
...
function views(url) {
    ...
    var mainHeight =  screen.height - 580;
    $("#addresMonitorModalHeight").height(mainHeight);
    var mainWidth = $(document.body).width() - 100;
    $("#addresMonitorModalWidth").width(mainWidth);
...
function news(){
	window.location.href='<%=basePath%>news/content';
}
</script>
</body>
</html>