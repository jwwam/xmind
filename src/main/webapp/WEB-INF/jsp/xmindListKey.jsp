 ...
 <aside class="main-sidebar">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>查询结果<small>数据全部来自<a href="https://www.xmind.net/share" target="_blank">官网</a></small></h1>
      <ol class="breadcrumb">
    ...
    <section class="content">
        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-header">
              ...
              <!-- <input type="button" value="按热度" class="btn btn-warning" style="line-height: 1.0;" onclick="hot()"/> -->
              	标题含有"<span style="color:red;">   ${key }   </span>"的结果共有<span style="color:red;">   ${count }   </span>条：
              </h3>
		  ...
		  <div class="pagelist" style="float:right;margin-top: 5px;">
			<a class="btn-inline" style="border-bottom: none;display: ;" href="javascript:window.location.href='<%=basePath%>news/find?pageNo=1&lang=${language}&key=${key}'">首页</a>
			<a class="btn-inline" style="border-bottom: none;display: ;" href="javascript:window.location.href='<%=basePath%>news/find?pageNo=${xmindList.previou}&lang=${language}&key=${key}'">上一页</a>
			<a class="btn-inline" style="border-bottom: none;display: ;" >当前显示第&nbsp;<i class="blue">${xmindList.pageNo}&nbsp;</i>页</a>
			<a class="btn-inline" style="border-bottom: none;display: ;" href="javascript:window.location.href='<%=basePath%>news/find?pageNo=${xmindList.next}&lang=${language}&key=${key}'">下一页</a>
			<a class="btn-inline" style="border-bottom: none;display: ;" href="javascript:window.location.href='<%=basePath%>news/find?pageNo=${xmindList.last}&lang=${language}&key=${key}'">尾页</a>
		  </div>
            </div>
            <!-- /.box-body -->
          </div>
